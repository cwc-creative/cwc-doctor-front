...
const WidgetTabs = ({id}) => {
    return <div id={id}
            className="moto-widget moto-widget_interactive moto-widget-tabs moto-spacing-top-medium moto-spacing-right-auto moto-spacing-bottom-auto moto-spacing-left-auto moto-preset-2 moto-widget-tabs_type-horizontal moto-disabling_row-fixed set-row-gutter-0"
            data-widget="tabs"
            data-preset="2">
            <div className="moto-widget-tabs__wrapper">
                <div
                    ...
                    style={{ width: "auto" }}
                >
                    <WidgetTabsHeader device="desktop" dataTab="wid_1561974481_hte37m5di" icon="fa-medkit" title="TECHNOLOGIE MODERNE" opened={true} />
