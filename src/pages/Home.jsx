...
const Home = () => {
  return <MainLayout>
    ...
    <WidgetBlock top="large" dataSpacing="laaa" dataBgImage="left top" anchorName="pricing">
        <WidgetRow classes="row-fixed"
        >
            <WidgetRowColumn classes="col-sm-12">
                <WidgetText dataSpacing="aaaa">
                ...
                <WidgetImage data_widget_id="wid_1561719023_h8wjpow8o" align="center" top="small">
                    <span className="moto-widget-image-link">
                        <img
                            data-src="/src/assets/images/home-divider.png"
                            className="moto-widget-image-picture lazyloaded"
        ...
        >
            <WidgetRowColumn classes="col-sm-4" top="medium" dataSpacing="maaa">
                <WidgetContainer containerContentId="5d15f1028" dataBgPosition="left top">
                    <WidgetSpacer data_widget_id="wid_1561719140_72wsms7nm" top="small" spacerHeight="15px" />
                    <WidgetRow classes="row-gutter-0" bottom="small"
                        dataGridType="xs"
                        dataSpacing="aasa"
                    >
                        <WidgetRowColumn classes="col-xs-6"></WidgetRowColumn>
                        <WidgetRowColumn classes="col-xs-6">
                            <WidgetContainer containerContentId="5d15f1719" dataBgPosition="left top">
                    ...
                    <WidgetText top="small" bottom="small" dataSpacing="sasa">
                        <p
                            className="moto-text_201"
                            style={{ textAlign: 'center' }}
                            >
                            140 000<span style={{ fontSize: '20px' }}>Ar</span>
                        </p>
                    </WidgetText>
                    <WidgetRow classes="row-gutter-0" top="small" bottom="small"
                        dataGridType="xs"
                        dataSpacing="sasa"
                    >
                        <WidgetRowColumn classes="col-xs-2"></WidgetRowColumn>
                        <WidgetRowColumn classes="col-xs-10">
                            <WidgetText right="small" dataSpacing="asaa">
                                <ul>
                                    <li className="moto-text_system_13">
                                        Review of Safety Program
                                    </li>
                                    <li className="moto-text_system_13">
                                        Annual Sexual Training
                                    </li>
                                    <li className="moto-text_system_13">
                                        Monthly Newsletter
                                    </li>
                    ...
                    <WidgetButton dataWidgetId="wid_1561719382_4xb6acg9q" align="center">
                        <a
                            href="/#appointment"
                            data-action="page"
                            className="moto-widget-button-link moto-size-large moto-link"
                        >
                            <span className="fa moto-widget-theme-icon"></span>
                            <span className="moto-widget-button-label">CHOISIR</span>
                        </a>
                    </WidgetButton>
                    <WidgetSpacer data_widget_id="wid_1561719410_w0ijpv3d8" top="medium" dataSpacing="maaa" spacerHeight="0px" />
                </WidgetContainer>
            </WidgetRowColumn>

            <WidgetRowColumn classes="col-sm-4" top="medium" dataSpacing="maaa">
                <WidgetContainer containerContentId="5d15f2f011" dataBgPosition="left top">
                    <WidgetSpacer data_widget_id="wid_1561719536_eutpb97s2" top="small" dataSpacing="saaa" spacerHeight="15px" />
                    <WidgetRow classes="row-gutter-0" bottom="small"
                        dataGridType="xs"
                        dataSpacing="aasa"
                    >
                        <WidgetRowColumn classes="col-xs-6"></WidgetRowColumn>
                        <WidgetRowColumn classes="col-xs-6">
                            <WidgetContainer containerContentId="5d15f2f010" dataBgPosition="left top">
                                    <WidgetText top="small" bottom="small" dataSpacing="sasa">
                                        <h3
                                          className="moto-text_system_14"
                                          style={{ textAlign: 'center' }}
                    ...
                    <WidgetText top="small" bottom="small" dataSpacing="sasa">
                        <p
                            ...
                            style={{ textAlign: 'center' }}
                            >
                            215 000<span style={{ fontSize: '20px' }}>Ar</span>
                        </p>
                    </WidgetText>
                    <WidgetRow classes="row-gutter-0" top="small" bottom="small"
                        dataGridType="xs"
                    ...
                    <WidgetButton dataWidgetId="wid_1561719536_86ufpzuaq" align="center">
                        <a
                            href="/#appointment"
                            data-action="page"
                            className="moto-widget-button-link moto-size-large moto-link"
                    ...
                    <WidgetSpacer data_widget_id="wid_1561719536_2ztet3yz3" top="medium" dataSpacing="maaa" spacerHeight="0px" />
                </WidgetContainer>
            </WidgetRowColumn>

            <WidgetRowColumn classes="col-sm-4" top="medium" dataSpacing="maaa">
                <WidgetContainer containerContentId="5d15f2f113" dataBgPosition="left top">
                    <WidgetSpacer data_widget_id="wid_1561719537_hpojlrbxm" top="small" dataSpacing="saaa" spacerHeight="15px" />
                    <WidgetRow classes="row-gutter-0" bottom="small"
                        dataGridType="xs"
                        dataSpacing="aasa"
                    >
                        <WidgetRowColumn classes="col-xs-6"></WidgetRowColumn>
                        <WidgetRowColumn classes="col-xs-6">
                            <WidgetContainer containerContentId="5d15f2f112" dataBgPosition="left top">
                                    <WidgetText top="small" bottom="small" dataSpacing="sasa">
                                        <h3
                                          className="moto-text_system_14"
                                          style={{ textAlign: 'center' }}
                    ...
                    <WidgetText top="small" bottom="small" dataSpacing="sasa">
                        <p
                            ...
                            style={{ textAlign: 'center' }}
                            >
                            293 000<span style={{ fontSize: '20px' }}>Ar</span>
                        </p>
                    </WidgetText>
                    <WidgetRow classes="row-gutter-0" top="small" bottom="small"
                        dataGridType="xs"
                    ...
                    <WidgetButton dataWidgetId="wid_1561719537_zatg9lkyi" align="center">
                        <a
                            href="/#appointment"
                            data-action="page"
                            className="moto-widget-button-link moto-size-large moto-link"
                    ...
                    <WidgetSpacer data_widget_id="wid_1561719537_h423urihk" top="medium" dataSpacing="maaa" spacerHeight="0px" />
                </WidgetContainer>
            </WidgetRowColumn>
